          ...
          <div className="w-full h-52 bg-white col-span-1 flex flex-col items-center p-4 justify-center">
            <div className="">
              <p className="flex gap-2 items-start text-sm">
                ...
                Your order quanlifies for FREE Shipping Choose this option at
            ...
            <button className="w-full font-titleFont font-medium text-base bg-gradient-to-tr from-yellow-400 to-yellow-200 border hover:from-yellow-300 hover:to-yellow border-yellow-500 hover:border-yellow-700 active:bg-gradient-to-bl active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-1">
              Proceed to pay
            </button>
          </div>
        </div>
